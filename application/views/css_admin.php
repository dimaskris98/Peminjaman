    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			...
			<a href="<?php echo base_url(); ?>">
                ...
                <a class="navbar-brand kiri" href="css_admin" style="font-size:25px">Peminjaman Gedung Politeknik Negeri Jember</a>
			</a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i>Pengajuan</a>
                        </li>
						<li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i>Info Jadwal</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Master<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Data Pengguna</a>
                                </li>
                                <li>
                                    <a href="morris.html">Data Petugas</a>
                                </li>
								<li>
                                    <a href="morris.html">Data Gedung</a>
                                </li>
								<li>
                                    <a href="morris.html">Data Fasilitas</a>
                                </li>
                            </ul>  
                        </li>
