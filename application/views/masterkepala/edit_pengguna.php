	...
	<form action="<?php echo base_url(). 'masterkepala/update/'.$id; ?>" method="post">
		...
		<tr>
			...
			<tr>
				...
				<td><input class="form-control separuh" placeholder="nama_pengguna" type="varchar" name="nama_pengguna" value="<?php echo $row->nama_pengguna ?>" readonly>
			...
			<tr>
				...
				<td><input class="form-control separuh" placeholder="password" type="varchar" name="password" value="<?php echo $row->password ?>" readonly>
